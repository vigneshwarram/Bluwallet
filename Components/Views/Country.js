...
export default class  Country  extends React.Component {
  ...
  constructor(props) {
    super(props);
    this. Country=['Peru','Ecuator','DenMark','Venezula','Guatemala','Mexico','Uruguay','Coloumbia','USA'],
...
(
    <TouchableOpacity onPress={()=>this.props.navigation.navigate('BankScreen',{SelectedCountry:item,SelectedCurrency:this.props.navigation.state.params.SelectedCurrency})}>
<View style={{justifyContent:'space-between',flexDirection:'row',marginLeft:20,marginRight:20}}>  
