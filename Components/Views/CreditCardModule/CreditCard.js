...
<View style={{flex:0.5}}>
<View> 
  <Animated.View style={{justifyContent:'center',alignItems:'center',opacity:this.state.AnimateOpacity}}> 
<Image  style={{width: 300, height: 300,resizeMode:'contain'}}  source={require("../assets/threelogo.png")}>
</Image>
 </Animated.View>
<View>
<Animated.View  style={{marginTop:this.state.AnimateMarginTop}}>
...
resizeMode: 'contain',}} source={require("../assets/creditCard.png")} ></Image> 
   ...
   <Animated.View style={{opacity:this.state.VisibleOpacity}}>
   <View
style={{
marginTop:10,
...
<Text style={{color:'#fff'}}>Accept</Text>
      ...
      AddCardAction=()=>{
        if(!this.state.AnimateView){
          ...
          Animated.timing(this.state.VisibleOpacity, {
            toValue:1,
            duration: 200,
            easing: Easing.inOut(Easing.ease),
            delay: 10,
          }).start();
          Animated.timing(this.state.AnimateMarginTop, {
            toValue: -250,
            duration: 200,
            easing: Easing.inOut(Easing.ease),
            delay: 10,
