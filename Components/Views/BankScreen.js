...
export default class  Bank  extends React.Component {
  ...
  constructor(props) {
    super(props);
    this. Country=[this.props.navigation.state.params.SelectedCurrency,this.props.navigation.state.params.SelectedCountry],
...
{this.Country.map((item,key)=>
(
    <TouchableOpacity onPress={()=>this.props.navigation.navigate('Country',{SelectedCountry:item,SelectedCurrency:this.props.navigation.state.params.SelectedCurrency})}>
<View style={{justifyContent:'space-between',flexDirection:'row',marginLeft:20,marginRight:20}}>  
...
<View style={{justifyContent:'space-between',flexDirection:'row',marginLeft:20,marginRight:20}}>  
<Text style={{fontSize:10,color:'#000000',marginTop:10,marginBottom:10}}>Title</Text>  
<Text style={{fontSize:10,color:'#00a5ff',marginTop:10,marginBottom:10}}>Bank Transfer</Text>  
...
/>
<View style={{justifyContent:'space-between',flexDirection:'row',marginLeft:20,marginRight:20}}>  
<Text style={{fontSize:10,color:'#000000',marginTop:10,marginBottom:10}}>Description</Text>  
<Text style={{fontSize:10,color:'#00a5ff',marginTop:10,marginBottom:10}}>Transfer Data</Text>  
