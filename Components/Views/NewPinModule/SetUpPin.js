...
SlideMenu=()=>{
  ...
  colors={['#ffffff','#e1e5ef','#e1e5ef']} style={{height:'100%'}}>   
   {/* <View style={{justifyContent:'center',alignItems:'center',position:'absolute',bottom:100,left:70,zIndex:1}}>
        <Image
        ...
        <View  style={{justifyContent:'center',alignItems:'center'
               ...
               <Text style={{color:'#4e649f',opacity:1,fontSize:18,marginTop:20,fontFamily:'Exo2-Bold'}}>Please Introduce New Pin</Text>
