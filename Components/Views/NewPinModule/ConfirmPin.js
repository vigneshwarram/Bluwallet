...
export default class ConfirmPin  extends React.Component {
  ...
  componentDidMount()
  {
    let pin=this.props.navigation.state.params.newpin
    console.log(pin)
   // this.autoFill()
...
SlideMenu=()=>{
  ...
  colors={['#ffffff','#e1e5ef','#e1e5ef']} style={{height:'100%'}}>   
        ...
        <View  style={{justifyContent:'center',alignItems:'center'
               ...
               <Text style={{color:'#4e649f',opacity:1,fontSize:18,marginTop:20,fontFamily:'Exo2-Bold'}}>Please Confirm  New Pin</Text>
      ...
      onComplete=async(inputtedPin, clear)=> {
       ...
       {
        Alert.alert('Alert','Confirm pin and new pins are not equal')
       }
      }
