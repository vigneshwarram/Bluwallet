...
export default class ConfirmVault extends React.Component {
...
HideMenu=()=>{
  ...
  style = {styles.activityIndicator}/>
    ...
    <Text style={{marginLeft:10,marginTop:15,fontSize:17,color:'#5496FF',fontFamily:'Exo2-Regular'}}>Selected coin</Text> 
    </View> 
   <View style={{marginTop:20}}>
   <View style={{justifyContent:'center',alignItems:'center'}}>
   <View style={{justifyContent:'center',alignItems:'center'}}> 
             <Text style={{color:'#5496FF',marginBottom:10,fontFamily:'Exo2-Regular'}}>{this.props.navigation.state.params.ImageTitle}</Text>
            <LinearGradient style={{  width: 110,
height: 110,
borderRadius: 110/2,
justifyContent:'center',alignItems:"center"}} colors= {[this.props.navigation.state.params.itemColor1,this.props.navigation.state.params.itemColor2,this.props.navigation.state.params.itemColor3]}>
   <Image style={{width: 60, height: 60}}   source={this.props.navigation.state.params.ImageName} ></Image> 
</LinearGradient>
      ...
      <View style={{flex:0.7,backgroundColor:'#ffffff',marginTop:20}}>
...
<Text style={{marginLeft:10,fontSize:12,color:'#354E91',fontFamily:'Exo2-Regular'}}>0.0000000BTC</Text>
      ...
      <View style={{borderBottomWidth:0.8,borderBottomColor:'#D1C9FF'}}>
<View style={{flexDirection:'row',justifyContent:'space-evenly',padding:20}}>
<Text style={{marginLeft:10,fontSize:11,color:'#5496FF',fontFamily:'Exo2-Regular'}}>Amount USD</Text>
<Text style={{marginLeft:10,fontSize:12,color:'#354E91',fontFamily:'Exo2-Regular'}}>0.000$</Text>
</View>
...
<Text style={{color:'#fff',fontSize:20,fontFamily:'Poppins-Medium'}}>Confirm</Text>
</LinearGradient>
        </View>
        </TouchableOpacity>
