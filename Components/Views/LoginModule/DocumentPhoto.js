  ...
  style = {styles.activityIndicator}/>
   ...
   colors={['#ffffff','#e1e5ef','#e1e5ef']} style={{height:'100%'}}>   
    ...
    <View> 
        ...
        <Text style={{color:'#4e649f',fontWeight:'bold',opacity:1,fontSize:20,marginTop:10,textAlign:'center'}}>Portrait + Document</Text>

             
             <Text style={{color:'#4e649f',opacity:1,fontSize:12,marginTop:10,}}>Make sure that your face and document it's clearly visible</Text>
