  ...
  style = {styles.activityIndicator}/>
   ...
   colors={['#ffffff','#e1e5ef','#e1e5ef']} style={{height:'100%'}}>   
    ...
    <View> 
        ...
        <Text style={{color:'#4e649f',fontWeight:'bold',opacity:1,fontSize:20,marginTop:10,textAlign:'center'}}>Take a  Photo of passport's photo page</Text>

             
             <Text style={{color:'#4e649f',opacity:1,fontSize:12,marginTop:10,}}>Make sure that your document is readable</Text>
