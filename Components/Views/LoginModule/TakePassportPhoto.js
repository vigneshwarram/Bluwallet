  ...
  colors= {['#FFFFFF','#DFE1ED','#CCCFE2']} style={{height:'100%'}}>   
   ...
   <View  style={{justifyContent:'center',alignItems:'center'
        ...
        <View  style={{justifyContent:'center',alignItems:'center',marginTop:10
                ...
                <Text style={{color:'#4e649f',opacity:1,fontSize:20,marginTop:10,textAlign:'center',fontFamily:'Exo2-Bold'}}>Take a  Photo of passport's photo page</Text>

             
<Text style={{color:'#4e649f',opacity:1,fontSize:12,marginTop:10,fontFamily:'Exo2-SemiBold'}}>Make sure that your document is readable</Text>
